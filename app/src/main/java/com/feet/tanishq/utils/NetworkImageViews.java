...
/**
 * Created by asif on 03-05-2016.
 */
public class NetworkImageViews extends TouchImageView {
    ...
    public NetworkImageViews(Context context) {
        this(context, null);
    }

    public NetworkImageViews(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NetworkImageViews(Context context, AttributeSet attrs, int defStyle) {
