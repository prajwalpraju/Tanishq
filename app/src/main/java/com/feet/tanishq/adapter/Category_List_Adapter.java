 ...
 */
public class Category_List_Adapter extends RecyclerView.Adapter<Category_List_Adapter.MyHolder>{

    Context context;
    ArrayList<CategoryList_Model> arr_list;
    AdapterCallback adapterCallback;
    String parentname,dir;

    ImageLoader imageLoader;
    public Category_List_Adapter(Context context, ArrayList<CategoryList_Model> arr_list,String parentname,String dir){
    ...
    public void onBindViewHolder(MyHolder holder, int position) {
        ...
        CategoryList_Model model=arr_list.get(holder.getAdapterPosition());
        ...
        }else if(model.getOnlineexclusive().equals("0")) {
